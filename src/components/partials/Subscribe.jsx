...
const Subscribe = () => {
  return (
    <>
      <div className="w-full h-[60vh] flex justify-center items-center mt-14 lg:mt-20 ">
        <div className="w-[90%] h-full bg-[#E7F9FD] rounded-3xl flex justify-center items-center flex-col ">
          <div className="w-[90%] h-[50%]  flex justify-center items-center flex-col">
            ...
            <h1 className="text-2xl lg:text-4xl font-bold leading-tight">Deliciousness to your inbox</h1>
          ...
          <div className="w-full h-[50%]  relative flex justify-center items-center rounded-r">
            <div className="flex w-[80%] md:w-[50%] lg:w-[40%] justify-center items-center bg-white rounded-xl p-4 ">
              <input
                type="email"
            ...
            <img src="../img1.png" className="hidden md:block absolute w-[25%]   bottom-0 left-0  " alt="" />      
            <img src="../img2.png" className="hidden md:block absolute w-[25%]   bottom-0 right-0 rounded-r-3xl" alt="" />      
          </div>
        </div>
